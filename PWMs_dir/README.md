This directory contains the KNN predicted PWMs for more than 1000 poorly studied KH proteins which were extracted from the [cisbp-rna database](http://cisbp-rna.ccbr.utoronto.ca/). It contains:
